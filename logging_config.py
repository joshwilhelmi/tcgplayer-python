...
class StructuredFormatter(logging.Formatter):
    ...
    def __init__(self, fmt: Optional[str] = None, datefmt: Optional[str] = None, 
                 json_format: bool = False, json_fields: Optional[Dict[str, str]] = None):
        """
...
class TCGPlayerLogger:
    ...
    def __init__(self, name: str = "tcgplayer_client", level: Optional[Union[str, int]] = None):
        """
    ...
    def _setup_handlers(self):
        ...
        file_formatter = StructuredFormatter(
            json_format=True,
            json_fields=DEFAULT_JSON_FORMAT
        )
    ...
    def add_file_handler(self, filepath: Union[str, Path], level: Union[str, int] = logging.DEBUG,
    ...
    def add_rotating_file_handler(self, filepath: Union[str, Path], 
...
def setup_logging(name: str = "tcgplayer_client", 
                 level: Optional[Union[str, int]] = None,
                 log_file: Optional[Union[str, Path]] = None,
                 json_format: bool = False) -> TCGPlayerLogger:
    """
