...
class CacheKeyGenerator:
    ...
    @staticmethod
    def generate_key(endpoint: str, params: Optional[Dict[str, Any]] = None, 
                    method: str = "GET", data: Optional[Any] = None) -> str:
        """
...
class LRUCache:
    ...
    async def get_stats(self) -> Dict[str, Any]:
        ...
        async with self._lock:
            ...
            if active_entries > 0:
                avg_ttl = sum(entry.ttl for entry in self.cache.values() if not entry.is_expired()) / active_entries
...
class ResponseCache:
    ...
    async def get_cached_response(self, endpoint: str, params: Optional[Dict[str, Any]] = None,
                                 method: str = "GET", data: Optional[Any] = None) -> Optional[Any]:
    ...
    async def cache_response(self, endpoint: str, params: Optional[Dict[str, Any]] = None,
                           method: str = "GET", data: Optional[Any] = None,
                           response: Any = None, status_code: int = 200,
